...
class DrinkViewController: UIViewController,SideMenuItemContent {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        //Add no data view to super view
    ...
    //Get All drink Recipe
    func getItems(){
        FTIndicator.showProgress(withMessage: "Loading..")
        wsManager.getDrinksRecipe { (sucess, items, message) in
