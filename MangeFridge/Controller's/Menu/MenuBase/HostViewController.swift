...
class HostViewController: MenuContainerViewController {
    ...
    private func contentControllers() -> [UIViewController] {
        ...
        let controllersIdentifiers = ["ID_SearchViewController","ID_DrinkTableViewController","ID_FoodTableViewController","ID_FavouriteTableViewController","ID_TopRatedTableViewController","ID_ProfileViewController"]
