...
- (void)layoutSubviews {
    ...
    CGRect frame = CGRectMake(0, 0, 100,4);
    ...
    [tagInputField_ setUserInteractionEnabled: FALSE];
...
- (void)reloadTagSubviews {
    ...
    UIColor *tagBackgrounColor = _tagsBackgroundColor != nil ? _tagsBackgroundColor : [UIColor whiteColor];
